...
angular.module('cgBusy').value('cgBusyButtonDefaults', {});
...
angular.module('cgBusy').directive('cgBusyButton', ['$compile', '$templateCache', 'cgBusyButtonDefaults', '$http', '_cgBusyTrackerFactory',
    function ($compile, $templateCache, cgBusyButtonDefaults, $http, _cgBusyTrackerFactory) {
        return {
            restrict: 'A',
            link: function (scope, element, attrs, fn) {
                ...
                angular.extend(defaults, cgBusyButtonDefaults);

                scope.$watchCollection(attrs.cgBusyButton, function (options) {
