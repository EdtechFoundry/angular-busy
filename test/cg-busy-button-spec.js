describe('cgBusyButton', function() {
	...
	it('should show the overlay during promise', function() {
		...
		this.element = compile('<div cg-busy-button="my_promise"></div>')(scope);
	...
	it('should show the overlay during multiple promises', function() {
		...
		this.element = compile('<div cg-busy-button="[my_promise,my_promise2]"></div>')(scope);
		angular.element('body').append(this.element);
	...
	it('should load custom templates', function(){
		...
		this.element = compile('<div cg-busy-button="{promise:my_promise,templateUrl:\'test-custom-template.html\'}"></div>')(scope);
		angular.element('body').append(this.element);
	...
	it('should delay when delay provided.', function() {
		...
		this.element = compile('<div cg-busy-button="{promise:my_promise,delay:300}"></div>')(scope);
		angular.element('body').append(this.element);
	...
	it('should use minDuration correctly.', function() {
		...
		this.element = compile('<div cg-busy-button="{promise:my_promise,minDuration:1000}"></div>')(scope);
		angular.element('body').append(this.element);
